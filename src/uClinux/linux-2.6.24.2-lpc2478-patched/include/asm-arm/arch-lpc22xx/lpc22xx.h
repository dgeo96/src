...
// See Chapter 2: LPC2468 memory map - 2. Memory maps
#define INTERNAL_FLASH_BASE	0x00000000 // up to 0x3FFFFFFF**
#define INTERNAL_FLASH_SIZE	0x0007FFFF // 512kB used in part for boot loader 
#define FAST_GPIO_BASE		0x3FFFC000 // 0x3FFFC000-0x3FFFFFF reserved for Fast GPIO
#define INTERNAL_RAM_BASE	0x40000000 // up to 0x7FFFFFFF** (in fact 0x7FD00000)
#define INTERNAL_RAM_SIZE	0x0000FFFF // 64kB
#define USB_RAM_BASE		0x7FD00000
#define USB_RAM_SIZE		0x00004000
#define ETH_RAM_BASE		0x7FE00000
#define ETH_RAM_SIZE		0x00004000
#define EXTERNAL_SMEM_BASE	0x80000000 // up to 0x83FFFFFF** in 4 blocks
#define EXTERNAL_SBLOCK		0x01000000
#define EXTERNAL_DBLOCK_BASE	0xA0000000 // up to 0xDFFFFFFF in 4 blocks
#define EXTERNAL_DBLOCK		0x10000000
#define APB_BASE		0xE0000000 // up to 0xE01FFFFF in 128 blocks
#define APB_BLOCK		0x00004000
#define APH_BASE		0xFFE00000 // up to 0xFFFFFFFF in 128 blocks
#define APH_BLOCK		0x00004000
// ** The first 64 bytes can be used for interrupt vectors see remapping using MEMMAP
...
#define APH_ETH_BASE		(APH_BASE+APH_ETH*APH_BLOCK)
#define APH_ETH_SIZE		APH_BLOCK
#define APH_GPDMA_BASE		(APH_BASE+APH_GPDMA*APH_BLOCK)
#define APH_GPDMA_SIZE		APH_BLOCK
#define APH_EMC_BASE		(APH_BASE+APH_EMC*APH_BLOCK)
#define APH_EMC_SIZE		APH_BLOCK
#define APH_USB_BASE		(APH_BASE+APH_USB*APH_BLOCK)
#define APH_USB_SIZE		APH_BLOCK
#define APH_VIC_BASE		(APH_BASE+APH_VIC*APH_BLOCK)
#define APH_VIC_SIZE		APH_BLOCK

// See Chapter 2: LPC2468 memory map - 3. APB peripheral addresses
#define APB_WDT			0
#define APB_TIMER0		1
#define APB_TIMER1		2
#define APB_UART0		3
...
#define APB_RTC			9
#define APB_GPIO		10
#define APB_PINSEL		11
#define APB_SSP1		12
#define APB_ADC			13
#define APB_CAN_B1		14
#define APB_CAN_B2		15
#define APB_CAN_B3		16
#define APB_CAN1		17
#define APB_CAN2		18
#define APB_I2C1		23
#define APB_SSP0		26
#define APB_DAC			27
#define APB_TIMER2		28
#define APB_TIMER3		29
#define APB_UART2		30
#define APB_UART3		31
#define APB_I2C2		32
#define APB_BRAM		33
#define APB_BATT_RAM		33
#define APB_I2S			34
#define APB_MMC			35
#define APB_SCB			127

#define APB_WDT_BASE		(APB_BASE+APB_WDT*APB_BLOCK)
#define APB_WDT_SIZE		APB_BLOCK
#define APB_TIMER0_BASE		(APB_BASE+APB_TIMER0*APB_BLOCK)
#define APB_TIMER0_SIZE		APB_BLOCK
#define APB_TIMER1_BASE		(APB_BASE+APB_TIMER1*APB_BLOCK)
#define APB_TIMER1_SIZE		APB_BLOCK
#define APB_UART0_BASE		(APB_BASE+APB_UART0*APB_BLOCK)
#define APB_UART0_SIZE		APB_BLOCK
#define APB_UART1_BASE		(APB_BASE+APB_UART1*APB_BLOCK)
#define APB_UART1_SIZE		APB_BLOCK
#define APB_PWM0_BASE		(APB_BASE+APB_PWM0*APB_BLOCK)
#define APB_PWM0_SIZE		APB_BLOCK
#define APB_PWM1_BASE		(APB_BASE+APB_PWM1*APB_BLOCK)
#define APB_PWM1_SIZE		APB_BLOCK
#define APB_I2C0_BASE		(APB_BASE+APB_I2C0*APB_BLOCK)
#define APB_I2C0_SIZE		APB_BLOCK
#define APB_SPI_BASE		(APB_BASE+APB_SPI*APB_BLOCK)
#define APB_SPI_SIZE		APB_BLOCK
#define APB_RTC_BASE		(APB_BASE+APB_RTC*APB_BLOCK)
#define APB_RTC_SIZE		APB_BLOCK
#define APB_GPIO_BASE		(APB_BASE+APB_GPIO*APB_BLOCK)
#define APB_GPIO_SIZE		APB_BLOCK
#define APB_GPIO_BASE		(APB_BASE+APB_GPIO*APB_BLOCK)
#define APB_GPIO_SIZE		APB_BLOCK
#define APB_PINSEL_BASE		(APB_BASE+APB_PINSEL*APB_BLOCK)
#define APB_PINSEL_SIZE		APB_BLOCK
#define APB_SSP1_BASE		(APB_BASE+APB_SSP1*APB_BLOCK)
#define APB_SSP1_SIZE		APB_BLOCK
#define APB_ADC_BASE		(APB_BASE+APB_ADC*APB_BLOCK)
#define APB_ADC_SIZE		APB_BLOCK
#define APB_CAN_B1_BASE		(APB_BASE+APB_CAN_B1*APB_BLOCK)
#define APB_CAN_B1_SIZE		APB_BLOCK
#define APB_CAN_B2_BASE		(APB_BASE+APB_CAN_B2*APB_BLOCK)
#define APB_CAN_B2_SIZE		APB_BLOCK
#define APB_CAN_B3_BASE		(APB_BASE+APB_CAN_B3*APB_BLOCK)
#define APB_CAN_B3_SIZE		APB_BLOCK
#define APB_CAN1_BASE		(APB_BASE+APB_CAN1*APB_BLOCK)
#define APB_CAN1_SIZE		APB_BLOCK
#define APB_CAN2_BASE		(APB_BASE+APB_CAN2*APB_BLOCK)
#define APB_CAN2_SIZE		APB_BLOCK
#define APB_I2C1_BASE		(APB_BASE+APB_I2C1*APB_BLOCK)
#define APB_I2C1_SIZE		APB_BLOCK
#define APB_SSP0_BASE		(APB_BASE+APB_SSP0*APB_BLOCK)
#define APB_SSP0_SIZE		APB_BLOCK
#define APB_DAC_BASE		(APB_BASE+APB_DAC*APB_BLOCK)
#define APB_DAC_SIZE		APB_BLOCK
#define APB_TIMER2_BASE		(APB_BASE+APB_TIMER2*APB_BLOCK)
#define APB_TIMER2_SIZE		APB_BLOCK
#define APB_TIMER3_BASE		(APB_BASE+APB_TIMER3*APB_BLOCK)
#define APB_TIMER3_SIZE		APB_BLOCK
#define APB_UART2_BASE		(APB_BASE+APB_UART2*APB_BLOCK)
#define APB_UART2_SIZE		APB_BLOCK
#define APB_UART3_BASE		(APB_BASE+APB_UART3*APB_BLOCK)
#define APB_UART3_SIZE		APB_BLOCK
#define APB_I2C2_BASE		(APB_BASE+APB_I2C2*APB_BLOCK)
#define APB_I2C2_SIZE		APB_BLOCK
#define APB_BRAM_BASE		(APB_BASE+APB_BRAM*APB_BLOCK)
#define APB_BRAM_SIZE		APB_BLOCK
#define APB_I2S_BASE		(APB_BASE+APB_I2S*APB_BLOCK)
#define APB_I2S_SIZE		APB_BLOCK
#define APB_MMC_BASE		(APB_BASE+APB_MMC*APB_BLOCK)
#define APB_MMC_SIZE		APB_BLOCK

/* APB=33 - Battery RAM */
#define APB_BRAM_ACTUAL_SIZE	0x0800

/* APH=2 - External Memory Controller (EMC) */
