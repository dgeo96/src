...
#ifdef CONFIG_MACH_VL420
# ifdef machine_arch_type
#  undef machine_arch_type
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_VL420
# endif
# define machine_is_unknown()	(machine_arch_type == MACH_TYPE_VL420)
#else
# define machine_is_unknown()	(0)
#endif
